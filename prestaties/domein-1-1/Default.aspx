...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
	...
	<main class="app-content t-domeinen" role="main">
		...
		<header class="page-header">
			<div class="container-fluid">
				<div class="page-header-content">
					<h1>Domein 1.1</h1>
					<p>Zich geborgen en op zijn gemak voelen</p>
				</div>
			</div>
		</header>
		...
		<div class="breadcrumb-wrapper">
			<div class="container-fluid">
				...
				<ol class="breadcrumb breadcrumb-alternate">
					...
					<li class="active">Domein 1.1 - Zich geborgen en op zijn gemak voelen</li>
				</ol>
			</div>
		</div>
										...
										<div class="form-horizontal">
											<div class="form-group">
												...
												<div class="col-md-9 btn-group" data-toggle="buttons">
													<button type="button" class="btn btn-success" data-toggle="dropdown">Ja</button>
											...
											<div class="form-group">
												...
												<div class="btn-group col-md-9" data-toggle="buttons">
													<button type="button" class="btn btn-warning" data-toggle="dropdown">Matig</button>
											...
											<div class="form-group">
												...
												<div class="btn-group col-md-9" data-toggle="buttons">
													<button type="button" class="btn btn-danger" data-toggle="dropdown">Hoog</button>
		...
		<section id="check" class="page-section">
			<div class="container-fluid">
				...
				<p>De organisatie evalueert periodiek de mate waarin de prestatie gerealiseerd wordt op basis van ten minste de activiteiten, instrumenten en (indicatoren) uitkomsten.</p>
				<br>

				<div class="panel panel-default" >
					<div class="panel-heading">
						<h2 class="panel-title">
							A1: Percentage bewoners met een decubitus categorie 2 of meer
						</h2>
					</div>
					<div class="panel-body ">
						<div class="row">
							<div class="col-md-6 text-center">
								Aantal geobserveerde bewonders met een decubituswonde categorie 2 of meer
								<hr>
								Totaal aantal aanwezige bewoners
							</div>
							...
							<div class="col-md-offset-1 col-md-2">
								<table class="table table-borderless">
									...
									<tbody>
										...
										<tr>
											<td class="text-right">Streefwaarde:</td>
											<td>
												<span class="label label-default">
													xx %
												</span>
			...
			<div class="container-fluid">
				...
				<div class="panel panel-default" >
					...
					<div class="panel-body ">
						<div class="row">
							<div class="col-md-8">
								<label for="" class="control-label">Algemene conclusie</label>
								<textarea class="form-control margin-bottom-half" rows="6"></textarea>
								<a href="#" class="btn btn-primary">Verbeterplan</a>

								<br><br><br>

								<label for="" class="control-label">Algemene doelstellingen</label>
								<textarea class="form-control margin-bottom-half" rows="6"></textarea>
							</div>
						</div>
					</div>
